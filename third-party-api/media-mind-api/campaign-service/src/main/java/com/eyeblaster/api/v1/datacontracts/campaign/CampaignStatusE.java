 ...
 */
            ...
            /**
            *  CampaignStatusE bean class
            */
        
        public  class CampaignStatusE
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CampaignStatusE.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                      ...
                                      if (localCampaignStatus==null){
                                        ...
                                        if (! namespace.equals("")) {
                                            ...
                                            if (prefix == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix,"CampaignStatus", namespace);
                                                xmlWriter.writeNamespace(prefix, namespace);
                                                xmlWriter.setPrefix(prefix, namespace);

                                            } else {
                                                xmlWriter.writeStartElement(namespace,"CampaignStatus");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("CampaignStatus");
                                        }
                                        ...
                                        xmlWriter.writeEndElement();
                                         ...
                                         localCampaignStatus.serialize(MY_QNAME,factory,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localCampaignStatus==null){
                                   ...
                                   return localCampaignStatus.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static CampaignStatusE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CampaignStatusE object =
                new CampaignStatusE();
