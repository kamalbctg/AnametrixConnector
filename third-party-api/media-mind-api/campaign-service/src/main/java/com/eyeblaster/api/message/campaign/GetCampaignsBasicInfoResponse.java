...
/**
 * GetCampaignsBasicInfoResponse.java
 *
 ...
 */
            ...
            /**
            *  GetCampaignsBasicInfoResponse bean class
            */
        
        public  class GetCampaignsBasicInfoResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://api.eyeblaster.com/message",
                "GetCampaignsBasicInfoResponse",
                "ns2");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.eyeblaster.api.v1.datacontracts.campaign.ArrayOfBasicInfo localInfo ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.eyeblaster.api.v1.datacontracts.campaign.ArrayOfBasicInfo getInfo(){
                               return localInfo;
                           }
                            ...
                            /**
                               ...
                               * @param param Info
                               */
                               public void setInfo(com.eyeblaster.api.v1.datacontracts.campaign.ArrayOfBasicInfo param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetCampaignsBasicInfoResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCampaignsBasicInfoResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCampaignsBasicInfoResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetCampaignsBasicInfoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCampaignsBasicInfoResponse object =
                new GetCampaignsBasicInfoResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCampaignsBasicInfoResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCampaignsBasicInfoResponse)com.eyeblaster.api.message.campaign.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setInfo(com.eyeblaster.api.v1.datacontracts.campaign.ArrayOfBasicInfo.Factory.parse(reader));
