 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfBrandInfo localBrands ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBrandsTracker = false ;
                           ...
                           */
                           public  com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfBrandInfo getBrands(){
                               return localBrands;
                           }
                            ...
                            /**
                               ...
                               * @param param Brands
                               */
                               public void setBrands(com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfBrandInfo param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localBrandsTracker = true;
                                       } else {
                                          localBrandsTracker = true;
                                              
                                       }
                                   
                                            this.localBrands=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetBrandsResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetBrandsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetBrandsResponse",
                                    ...
                                    if (localBrands==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"Brands", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"Brands");
                                            }
                                     ...
                                     localBrands.serialize(new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Brands"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localBrandsTracker){
                            elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                    ...
                                    elementList.add(localBrands==null?null:
                                    localBrands);
                                } if (localTotalCountTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                                                      "TotalCount"));
    ...
    public static class Factory{
        ...
        */
        public static GetBrandsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBrandsResponse object =
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetBrandsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBrandsResponse)com.eyeblaster.api.message.advertiser.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Brands").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setBrands(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setBrands(com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfBrandInfo.Factory.parse(reader));
