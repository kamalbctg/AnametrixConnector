 ...
 */
            ...
            /**
            *  GetCurrenciesResponse bean class
            */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for Currencies
                        */

                        
                                    protected com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfCurrencyInfo localCurrencies ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCurrenciesTracker = false ;
                           ...
                           */
                           public  com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfCurrencyInfo getCurrencies(){
                            ...
                            /**
                               ...
                               * @param param Currencies
                               */
                               public void setCurrencies(com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfCurrencyInfo param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localCurrenciesTracker = true;
                                       } else {
                                          localCurrenciesTracker = true;
                                              
                                       }
                                   
                                            this.localCurrencies=param;
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetCurrenciesResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCurrenciesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCurrenciesResponse",
                                    ...
                                    if (localCurrencies==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"Currencies", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"Currencies");
                                            }
                                     ...
                                     localCurrencies.serialize(new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Currencies"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localCurrenciesTracker){
                            elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                    ...
                                    elementList.add(localCurrencies==null?null:
                                    localCurrencies);
                                } if (localTotalCountTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                                                      "TotalCount"));
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCurrenciesResponse".equals(type)){
                                ...
                                return (GetCurrenciesResponse)com.eyeblaster.api.message.advertiser.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Currencies").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setCurrencies(com.eyeblaster.api.v1.datacontracts.advertiser.ArrayOfCurrencyInfo.Factory.parse(reader));
