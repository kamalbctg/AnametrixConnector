 ...
 */
            ...
            /**
            *  AdsRotationMethodE bean class
            */
        
        public  class AdsRotationMethodE
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AdsRotationMethodE.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                      ...
                                      if (localAdsRotationMethod==null){
                                        ...
                                        if (! namespace.equals("")) {
                                            ...
                                            if (prefix == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix,"AdsRotationMethod", namespace);
                                                xmlWriter.writeNamespace(prefix, namespace);
                                                xmlWriter.setPrefix(prefix, namespace);

                                            } else {
                                                xmlWriter.writeStartElement(namespace,"AdsRotationMethod");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("AdsRotationMethod");
                                        }
                                        ...
                                        xmlWriter.writeEndElement();
                                         ...
                                         localAdsRotationMethod.serialize(MY_QNAME,factory,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localAdsRotationMethod==null){
                                   ...
                                   return localAdsRotationMethod.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static AdsRotationMethodE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AdsRotationMethodE object =
                new AdsRotationMethodE();
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts","AdsRotationMethod").equals(reader.getName())){
                                      ...
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setAdsRotationMethod(null);
                                          reader.next();
