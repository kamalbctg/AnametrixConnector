 ...
 */
            ...
            /**
            *  ServingOrderE bean class
            */
        
        public  class ServingOrderE
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ServingOrderE.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                      ...
                                      if (localServingOrder==null){
                                        ...
                                        if (! namespace.equals("")) {
                                            ...
                                            if (prefix == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix,"ServingOrder", namespace);
                                                xmlWriter.writeNamespace(prefix, namespace);
                                                xmlWriter.setPrefix(prefix, namespace);

                                            } else {
                                                xmlWriter.writeStartElement(namespace,"ServingOrder");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("ServingOrder");
                                        }
                                        ...
                                        xmlWriter.writeEndElement();
                                         ...
                                         localServingOrder.serialize(MY_QNAME,factory,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localServingOrder==null){
                                   ...
                                   return localServingOrder.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static ServingOrderE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ServingOrderE object =
                new ServingOrderE();
