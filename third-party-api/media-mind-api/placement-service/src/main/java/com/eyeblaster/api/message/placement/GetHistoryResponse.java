 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for HistoryLogs
                        */

                        
                                    protected com.eyeblaster.api.v1.datacontracts.placement.ArrayOfHistoryInfo localHistoryLogs ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localHistoryLogsTracker = false ;
                           ...
                           */
                           public  com.eyeblaster.api.v1.datacontracts.placement.ArrayOfHistoryInfo getHistoryLogs(){
                               return localHistoryLogs;
                           }
                            ...
                            /**
                               ...
                               * @param param HistoryLogs
                               */
                               public void setHistoryLogs(com.eyeblaster.api.v1.datacontracts.placement.ArrayOfHistoryInfo param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localHistoryLogsTracker = true;
                                       } else {
                                          localHistoryLogsTracker = true;
                                              
                                       }
                                   
                                            this.localHistoryLogs=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localHistoryLogsTracker){
                                    if (localHistoryLogs==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"HistoryLogs", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"HistoryLogs");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("HistoryLogs");
                                        }
                                     ...
                                     localHistoryLogs.serialize(new javax.xml.namespace.QName("http://api.eyeblaster.com/message","HistoryLogs"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localHistoryLogsTracker){
                            elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                    ...
                                    elementList.add(localHistoryLogs==null?null:
                                    localHistoryLogs);
                                } if (localTotalCountTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                                                      "TotalCount"));
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetHistoryResponse".equals(type)){
                                ...
                                return (GetHistoryResponse)com.eyeblaster.api.message.placement.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","HistoryLogs").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setHistoryLogs(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setHistoryLogs(com.eyeblaster.api.v1.datacontracts.placement.ArrayOfHistoryInfo.Factory.parse(reader));
