...
/**
 * InStreamVideoPlacementInfo.java
 *
 ...
 */
            ...
            /**
            *  InStreamVideoPlacementInfo bean class
            */
        
        public  class InStreamVideoPlacementInfo extends com.eyeblaster.api.v1.datacontracts.placement.PlacementInfo
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = InStreamVideoPlacementInfo
                           ...
                           */
                           public  boolean getIsVast(){
                            ...
                            /**
                               ...
                               * @param param IsVast
                               */
                               public void setIsVast(boolean param){
                            
                                            this.localIsVast=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       InStreamVideoPlacementInfo.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InStreamVideoPlacementInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"IsVast", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"IsVast");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("IsVast");
                                    }
                                               ...
                                               if (false) {
                                                    ...
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsVast));
                                               }
                                    
                                   xmlWriter.writeEndElement();
                             
                                            if (localVideoDuration==null){
                                                 throw new org.apache.axis2.databinding.ADBException("VideoDuration cannot be null!!");
                                            }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts","InStreamVideoPlacementInfo"));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsVast));
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts",
                                    ...
                                    elementList.add(localVideoDuration);
    ...
    public static class Factory{
        ...
        */
        public static InStreamVideoPlacementInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InStreamVideoPlacementInfo object =
                new InStreamVideoPlacementInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InStreamVideoPlacementInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InStreamVideoPlacementInfo)com.eyeblaster.api.message.placement.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts","IsVast").equals(reader.getName())){
