 ...
 */
            ...
            /**
            *  CopyPlacementsResponse bean class
            */
        
        public  class CopyPlacementsResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://api.eyeblaster.com/message",
                "CopyPlacementsResponse",
                "ns1");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.eyeblaster.api.message.placement.ArrayOfBatchActionError localBatchActionErrors ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.eyeblaster.api.message.placement.ArrayOfBatchActionError getBatchActionErrors(){
                            ...
                            /**
                               ...
                               */
                               public void setBatchActionErrors(com.eyeblaster.api.message.placement.ArrayOfBatchActionError param){
                        ...
                        /**
                        * field for Placements
                        */

                        
                                    protected com.eyeblaster.api.v1.datacontracts.placement.ArrayOfPlacementInfo localPlacements ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPlacementsTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return com.eyeblaster.api.v1.datacontracts.ArrayOfPlacementInfo
                           */
                           public  com.eyeblaster.api.v1.datacontracts.placement.ArrayOfPlacementInfo getPlacements(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Placements
                               */
                               public void setPlacements(com.eyeblaster.api.v1.datacontracts.placement.ArrayOfPlacementInfo param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localPlacementsTracker = true;
                                       } else {
                                          localPlacementsTracker = true;
                                              
                                       }
                                   
                                            this.localPlacements=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CopyPlacementsResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CopyPlacementsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CopyPlacementsResponse",
                ...
                if (localBatchActionErrorsTracker){
                                ...
                                } if (localPlacementsTracker){
                                    if (localPlacements==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"Placements", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"Placements");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("Placements");
                                        }
                                     ...
                                     localPlacements.serialize(new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Placements"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localBatchActionErrorsTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                    ...
                                    elementList.add(localPlacements==null?null:
                                    localPlacements);
                                } if (localTotalCountTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                                                      "TotalCount"));
    ...
    public static class Factory{
        ...
        */
        public static CopyPlacementsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CopyPlacementsResponse object =
                new CopyPlacementsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CopyPlacementsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CopyPlacementsResponse)com.eyeblaster.api.message.placement.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setBatchActionErrors(com.eyeblaster.api.message.placement.ArrayOfBatchActionError.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Placements").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setPlacements(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setPlacements(com.eyeblaster.api.v1.datacontracts.placement.ArrayOfPlacementInfo.Factory.parse(reader));
