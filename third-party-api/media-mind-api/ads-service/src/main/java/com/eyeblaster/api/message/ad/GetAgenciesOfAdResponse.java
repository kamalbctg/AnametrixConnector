 ...
 */
            ...
            /**
            *  GetAgenciesOfAdResponse bean class
            */
        
        public  class GetAgenciesOfAdResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://api.eyeblaster.com/message",
                "GetAgenciesOfAdResponse",
                "ns1");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.eyeblaster.api.v1.datacontracts.ad.ArrayOfBasicInfo localAgencies ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAgenciesTracker = false ;
                           ...
                           */
                           public  com.eyeblaster.api.v1.datacontracts.ad.ArrayOfBasicInfo getAgencies(){
                            ...
                            /**
                               ...
                               * @param param Agencies
                               */
                               public void setAgencies(com.eyeblaster.api.v1.datacontracts.ad.ArrayOfBasicInfo param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localAgenciesTracker = true;
                                       } else {
                                          localAgenciesTracker = true;
                                              
                                       }
                                   
                                            this.localAgencies=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetAgenciesOfAdResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAgenciesOfAdResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAgenciesOfAdResponse",
                                    ...
                                    if (localAgencies==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"Agencies", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"Agencies");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("Agencies");
                                        }
                                     ...
                                     localAgencies.serialize(new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Agencies"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localAgenciesTracker){
                            elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                    ...
                                    elementList.add(localAgencies==null?null:
                                    localAgencies);
                                } if (localTotalCountTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                                                      "TotalCount"));
    ...
    public static class Factory{
        ...
        */
        public static GetAgenciesOfAdResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAgenciesOfAdResponse object =
                new GetAgenciesOfAdResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAgenciesOfAdResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAgenciesOfAdResponse)com.eyeblaster.api.message.ad.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","Agencies").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setAgencies(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setAgencies(com.eyeblaster.api.v1.datacontracts.ad.ArrayOfBasicInfo.Factory.parse(reader));
