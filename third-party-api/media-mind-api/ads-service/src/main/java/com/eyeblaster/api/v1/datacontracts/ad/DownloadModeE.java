 ...
 */
            ...
            /**
            *  DownloadModeE bean class
            */
        
        public  class DownloadModeE
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DownloadModeE.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                      ...
                                      if (localDownloadMode==null){
                                        ...
                                        if (! namespace.equals("")) {
                                            ...
                                            if (prefix == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix,"DownloadMode", namespace);
                                                xmlWriter.writeNamespace(prefix, namespace);
                                                xmlWriter.setPrefix(prefix, namespace);

                                            } else {
                                                xmlWriter.writeStartElement(namespace,"DownloadMode");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("DownloadMode");
                                        }
                                        ...
                                        xmlWriter.writeEndElement();
                                         ...
                                         localDownloadMode.serialize(MY_QNAME,factory,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localDownloadMode==null){
                                   ...
                                   return localDownloadMode.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static DownloadModeE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DownloadModeE object =
                new DownloadModeE();
