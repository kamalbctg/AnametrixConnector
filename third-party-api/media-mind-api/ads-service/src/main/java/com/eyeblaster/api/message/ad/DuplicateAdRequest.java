 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for CopyPlacmentSettings
                        */

                        
                                    protected boolean localCopyPlacmentSettings ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCopyPlacmentSettingsTracker = false ;
                           ...
                           * @return boolean
                           */
                           public  boolean getCopyPlacmentSettings(){
                               return localCopyPlacmentSettings;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param CopyPlacmentSettings
                               */
                               public void setCopyPlacmentSettings(boolean param){
                            
                                       // setting primitive attribute tracker to true
                                       
                                               if (false) {
                                           localCopyPlacmentSettingsTracker = false;
                                              
                                       } else {
                                          localCopyPlacmentSettingsTracker = true;
                                       }
                                   
                                            this.localCopyPlacmentSettings=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DuplicateAdRequest.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DuplicateAdRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DuplicateAdRequest",
                ...
                if (localAdIDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localCopyPlacmentSettingsTracker){
                                    namespace = "http://api.eyeblaster.com/message";
                                    if (! namespace.equals("")) {
                                        prefix = xmlWriter.getPrefix(namespace);
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"CopyPlacmentSettings", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"CopyPlacmentSettings");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("CopyPlacmentSettings");
                                    }
                                
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("CopyPlacmentSettings cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCopyPlacmentSettings));
                                               }
                 ...
                 if (localAdIDTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCopyClickthroughAndTrackingURLs));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/message",
                                                                      "CopyPlacmentSettings"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCopyPlacmentSettings));
                            }
    ...
    public static class Factory{
        ...
        */
        public static DuplicateAdRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DuplicateAdRequest object =
                new DuplicateAdRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DuplicateAdRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DuplicateAdRequest)com.eyeblaster.api.message.ad.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","AdName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","CopyPlacmentSettings").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setCopyPlacmentSettings(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(content));
