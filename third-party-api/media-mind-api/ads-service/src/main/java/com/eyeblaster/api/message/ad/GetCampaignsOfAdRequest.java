 ...
 */
            ...
            /**
            *  GetCampaignsOfAdRequest bean class
            */
        
        public  class GetCampaignsOfAdRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://api.eyeblaster.com/message",
                "GetCampaignsOfAdRequest",
                "ns1");
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMediaAgencyIDTracker = false ;
                               ...
                               */
                               public void setMediaAgencyID(int param){
                                       ...
                                       // setting primitive attribute tracker to true
                                               ...
                                               if (param==java.lang.Integer.MIN_VALUE) {
                                           localMediaAgencyIDTracker = false;
                                              
                                       } else {
                                          localMediaAgencyIDTracker = true;
                                       }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetCampaignsOfAdRequest.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetCampaignsOfAdRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetCampaignsOfAdRequest",
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        xmlWriter.writeStartElement("MediaAgencyID");
                                               ...
                                               if (localMediaAgencyID==java.lang.Integer.MIN_VALUE) {
                                                         ...
                                                         throw new org.apache.axis2.databinding.ADBException("MediaAgencyID cannot be null!!");
    ...
    public static class Factory{
        ...
        */
        public static GetCampaignsOfAdRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCampaignsOfAdRequest object =
                new GetCampaignsOfAdRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetCampaignsOfAdRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCampaignsOfAdRequest)com.eyeblaster.api.message.ad.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/message","MediaAgencyID").equals(reader.getName())){
