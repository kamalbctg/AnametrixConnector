 ...
 */
            ...
            /**
            *  AdStatusE bean class
            */
        
        public  class AdStatusE
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AdStatusE.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                      ...
                                      if (localAdStatus==null){
                                        ...
                                        if (! namespace.equals("")) {
                                            ...
                                            if (prefix == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix,"AdStatus", namespace);
                                                xmlWriter.writeNamespace(prefix, namespace);
                                                xmlWriter.setPrefix(prefix, namespace);

                                            } else {
                                                xmlWriter.writeStartElement(namespace,"AdStatus");
                                            }
                                        ...
                                        xmlWriter.writeEndElement();
                                         ...
                                         localAdStatus.serialize(MY_QNAME,factory,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localAdStatus==null){
                                   ...
                                   return localAdStatus.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static AdStatusE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AdStatusE object =
                new AdStatusE();
